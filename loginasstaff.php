...
<head>
	...
	<title>Login As a Staff Member </title>  
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	<style>
		body{
			background: url('./staffg.jpeg');
			display: flex;
...
<body> 
	<form action="stafflogin.php" method="post"  class="login">
		<header><img src="./stafflogo.jpg"></header>
		<h2>Login As a Staff Member </h2></br>
		<div class="field"><span class="fa fa-username"><input type="text" name="username" placeholder="Email or User name"></span></div>
